            ...
            <div class="flex flex-wrap mb-24 -mx-3">
                <div class="w-full pr-2 lg:w-1/4 lg:block">
                        ...
                        <ul>
                            <li class="mb-4">
                                <label for="" class="flex items-center dark:text-gray-300">
                                    <input type="checkbox" wire:model.live="status" class="w-4 h-4 mr-2">
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
                        <div>
                            <div class="font-semibold"> {{ \Illuminate\Support\Number::currency($price_range),'EUR' }}</div>
                            <input type="range" wire:model.live="price_range" class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" max="1500" value="200" step="10">
                            <div class="flex justify-between ">
                                <span class="inline-block text-lg font-bold text-blue-400 ">
                                    {{ \Illuminate\Support\Number::currency(10,'EUR') }}
                                </span>
                                <span class="inline-block text-lg font-bold text-blue-400 ">
                                    {{ \Illuminate\Support\Number::currency(1500,'EUR') }}
                            ...
                            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3">
                                <div class="border border-gray-300 dark:border-gray-700">
                                    ...
                                    <div class="p-3 ">
                                        ...
                                        <p class="text-lg ">
                                            <span class="text-green-600 dark:text-green-600">{{\Illuminate\Support\Number::currency($product->price, 'EUR') }}</span>
                                        </p>
                                    </div>
