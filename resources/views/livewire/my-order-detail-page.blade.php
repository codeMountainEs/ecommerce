                    ...
                    <div class="mt-1 flex items-center gap-x-2">
                        @php
                            $payment_status ='';
                               ...
                               $payment_status = '<span class="bg-green-500 py-1 px-3 rounded text-white shadow">Paid
                ...
                <table class="w-full">
                    ...
                    @foreach ($order_items as $item)
                        <tr wire:key="{{$item->id}}">
                            ...
                            <td class="py-4">{{ \Illuminate\Support\Number::currency($item->total_amount,'EUR')}}</td>
                        </tr>
                        <!--[if ENDBLOCK]><![endif]-->
                    @endforeach
                    </tbody>
        ...
        <div class="md:w-1/4">
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="flex justify-between mb-2">
                    <span>Subtotal</span>
                    <span>{{\Illuminate\Support\Number::currency($item->order->grand_total,'EUR')}}</span>
                </div>
                <div class="flex justify-between mb-2">
                    <span>Taxes</span>
                    <span>₹0.00</span>
                ...
                <div class="flex justify-between mb-2">
                    ...
                    <span class="font-semibold">{{\Illuminate\Support\Number::currency($item->order->grand_total,'EUR')}}</span>
                </div>
